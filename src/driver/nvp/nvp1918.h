...
#define IOC_VIDEO_GET_VIDEO_LOSS	0x04  //yk change
//#define NVP1114A_SET_IMAGE_ADJUST	    0x05
#define IOC_VIDEO_GET_IMAGE_ADJUST 	0x05	//yk change
...
#define IOC_VDEC_SET_AUDIO_PARM                 0x65
...
//yk add 20130412
typedef struct _nvp_image_adjust
{
    unsigned char chip;
    unsigned char ch;
	unsigned char hue;
	...
	unsigned long item_sel;/* use such as HUE|CONTRAST" */
} nvp_image_adjust;
typedef struct _vdec_audio_volume_parm
{
    unsigned char AIN_0;
    unsigned char AIN_1;
    unsigned char AIN_2;
