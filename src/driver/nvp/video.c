...
#ifdef VDEC_108M
#define wwww 0x48
		gpio_i2c_write(vdec_slave_addr[i], 0x58, wwww);
		gpio_i2c_write(vdec_slave_addr[i], 0x59, wwww);
		gpio_i2c_write(vdec_slave_addr[i], 0x5A, wwww);
		gpio_i2c_write(vdec_slave_addr[i], 0x5B, wwww);
		gpio_i2c_write(vdec_slave_addr[i], 0xD8, wwww);
		gpio_i2c_write(vdec_slave_addr[i], 0xD9, wwww);
		gpio_i2c_write(vdec_slave_addr[i], 0xDA, wwww);
		gpio_i2c_write(vdec_slave_addr[i], 0xDB, wwww);
#else
	...
	reversion2_fix();
	//audio_init(vdec_slave_addr[i], 16, 0, 1); zsk mod
	audio_init(vdec_slave_addr[i],16,0,0);
	printk("\n\rzsk set audio_init");	
